...
function print_sales_orders()
{
	...
	$cols = array(4, 40, 225, 300, 325, 430, 450, 515);
...
$rep->TextCol(0, 1,	$s++, -2);
		...
		$rep->TextCol(5, 7,	$DisplaySubTot, -2);
		//$rep->NewLine();
		...
		if ($myrow['tax_included'] == 0) {
			...
			$rep->TextCol(5, 7,	$DisplayTotal, -2);
			$rep->NewLine();
		}
			...
			if ($myrow['tax_included'])
			{
				if (isset($alternative_tax_include_on_docs) && $alternative_tax_include_on_docs == 1)
				{
					if ($first)
					{
						...
						$rep->TextCol(5, 7,	number_format2($sign*$tax_item['net_amount'], $dec), -2);
						$rep->NewLine();
					}
