...
function get_transactions($debtorno, $from, $to)
{
	...
	$to = date2sql($to);
     ...
     $sql = "SELECT trans.*,
 		(trans.ov_amount + trans.ov_gst + trans.ov_freight + trans.ov_freight_tax + trans.ov_discount - trans.discount1 - trans.discount2) AS TotalAmount,
...
function print_customer_balances()
{
	...
	$headers = array(_('#'), _('Date'), _('Trans Type'), _('Due Date'), _('Charges'), _('Credits'),
