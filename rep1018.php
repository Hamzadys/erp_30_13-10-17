...
if ($folk == ALL_NUMERIC)
	...
	$cols = array(0, 90, 190, 250,	320, 385, 450, 515);

	$headers = array(_('Customer'), _(''), _(''), _('Sale'), _('Recovery'), _('Difference'),
_(''));
	...
	$sql = "SELECT ".TB_PREF."debtors_master.debtor_no, ".TB_PREF."debtors_master.name, ".TB_PREF."debtors_master.curr_code, ".TB_PREF."debtors_master.address 
	FROM 
