...
function print_deliveries()
{
	...
	$cols = array(4, 60, 225, 300, 325, 485, 450, 515);
...
$a++;
		...
		$rep->MultiCell(510, 35, "We are pleased to deliver following lubricants/greases as per your purchase order. Invoice will be submitted to you seperately." , 0, 'L', 0, 2, 40,302, true);
		//$rep->font('b');
		$rep->MultiCell(527, 130, " " , 1, 'L', 0, 2, 40,695, true);
$rep->MultiCell(131.75, 130, "Received By(Name) " , 0, 'C', 0, 2, 40,810, true);
$rep->MultiCell(131.75, 130, "Designation " , 0, 'C', 0, 2, 171.75,810, true);
$rep->MultiCell(131.75, 130, "Customer Signature & Stamp " , 0, 'C', 0, 2, 303.5,810, true);
$rep->MultiCell(131.75, 130, "Receving Date & Time " , 0, 'C', 0, 2, 435.25,810, true);
$rep->MultiCell(131.75, 130, " " , 1, 'L', 0, 2, 171.75,695, true);
$rep->MultiCell(131.75, 130, " " , 1, 'L', 0, 2, 303.5,695, true);
