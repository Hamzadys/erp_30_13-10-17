...
function get_open_balance($supplier_id, $to)
{
    ...
    $sql = "SELECT
    	SUM(IF(type IN(".ST_SUPPINVOICE.",".ST_BANKDEPOSIT.",".ST_CRV."), (ov_amount + ov_gst + ov_discount), 0)) AS charges,
    	SUM(IF(type NOT IN(".ST_SUPPINVOICE.",".ST_BANKDEPOSIT.",".ST_CRV."), (ov_amount + ov_gst + ov_discount), 0)) AS credits,
		SUM(IF(type NOT IN(".ST_SUPPINVOICE.",".ST_BANKDEPOSIT.",".ST_CRV."),alloc * -1, alloc)) AS Allocated,
		SUM(IF(type IN(".ST_SUPPINVOICE.",".ST_BANKDEPOSIT.",".ST_CRV."), (ov_amount + ov_gst + ov_discount - alloc),
