...
function get_invoices($customer_id, $to, $all=true)
{
	...
	//Ryan :06-05-17
	if ($all)
    	$value = "(ov_amount + ov_gst + ov_freight + ov_freight_tax + ov_discount + ".TB_PREF."debtor_trans.gst_wh +
		".TB_PREF."debtor_trans.supply_disc + ".TB_PREF."debtor_trans.service_disc + ".TB_PREF."debtor_trans.fbr_disc + ".TB_PREF."debtor_trans.srb_disc + ".TB_PREF.".discount1 - ".TB_PREF.".discount2)";
	else
    	$value = "(ov_amount + ov_gst + ov_freight + ov_freight_tax + ov_discount +	".TB_PREF."debtor_trans.gst_wh  + ".TB_PREF."debtor_trans.supply_disc + ".TB_PREF."debtor_trans.service_disc + ".TB_PREF."debtor_trans.fbr_disc + ".TB_PREF."debtor_trans.srb_disc + ".TB_PREF.".discount1 - ".TB_PREF.".discount2 - alloc)";
	...
	$sql = "SELECT type, reference, tran_date,
		...
		WHERE type <> ".ST_CUSTDELIVERY."
			...
			AND ABS(".TB_PREF."debtor_trans.ov_amount + ".TB_PREF."debtor_trans.ov_gst + ".TB_PREF."debtor_trans.ov_freight + ".TB_PREF."debtor_trans.ov_freight_tax + ".TB_PREF."debtor_trans.ov_discount  + ".TB_PREF."debtor_trans.gst_wh +
".TB_PREF."debtor_trans.supply_disc + ".TB_PREF."debtor_trans.service_disc + ".TB_PREF."debtor_trans.fbr_disc + ".TB_PREF."debtor_trans.srb_disc - ".TB_PREF."debtor_trans.discount1 - ".TB_PREF."debtor_trans.discount2) > ".FLOAT_COMP_DELTA." ";
	if (!$all)
		$sql .= "AND ABS(".TB_PREF."debtor_trans.ov_amount + ".TB_PREF."debtor_trans.ov_gst + ".TB_PREF."debtor_trans.ov_freight + ".TB_PREF."debtor_trans.ov_freight_tax + ".TB_PREF."debtor_trans.ov_discount  + ".TB_PREF."debtor_trans.gst_wh +
		".TB_PREF."debtor_trans.supply_disc + ".TB_PREF."debtor_trans.service_disc + ".TB_PREF."debtor_trans.fbr_disc + ".TB_PREF."debtor_trans.srb_disc - ".TB_PREF."debtor_trans.discount1 - ".TB_PREF."debtor_trans.discount2 - ".TB_PREF."debtor_trans.alloc) > ".FLOAT_COMP_DELTA." ";
