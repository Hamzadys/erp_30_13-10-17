...
function print_deliveries()
{
	...
	$cols = array(4, 60, 300, 450);

	// $headers in doctext.inc
	$aligns = array('left',	'left',	'left', 'left');
	$headers = array(_("S.No"), _("Description"), _("Packing"),
		_("Qty"));
...
//							$rep->TextCol(3, 7, _("Included") . " " . $tax_type_name . _("Amount") . ": " . $DisplayTax, -2);
		...
		$rep->MultiCell(770, 30, "Against Sale Order No.", 0, 'L', 0,1,357,90, true);
		...
		$rep->MultiCell(770, 30, "Requested By:", 0, 'L', 0,1,40,750, true);
		...
		$rep->MultiCell(770, 30, "Approved By:", 0, 'L', 0,1,357,750, true);
